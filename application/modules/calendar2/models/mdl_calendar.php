...

{
    ...
    public function insert_data_calendar()
    {
        ...
        $data_array = array(
            ...
            'LEAVE_ID ' => $this->input->post('leave_type_name'),
            'DESCRIPTION' => $this->input->post('description'),
            'DATE_START' => $this->input->post('date_start'),
            'DATE_END' => $date_end,
            'TOTAL' => $diff->format('%a'),
            'LEAVE_TYPE_ID ' => $this->input->post('leave'),
            'TIME_S_ID' => $start,
            'TIME_E_ID' => $end,
    ...
    public function update_data_calendar()
    {
        ...
        $data_array = array(
            ...
            'LEAVE_ID ' => $this->input->post('leave_type_name_up'),
            ...
            'LEAVE_TYPE_ID ' => $this->input->post('leave_up'),
            'TIME_S_ID' => $start_up,
            'TIME_E_ID' => $end_up,
            'USER_STAFF_ID' =>  $this->session->userdata('user_code'),
        );
